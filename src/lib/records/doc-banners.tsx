...
import { VerticalLappetParticleFieldSplash } from "@/components/splash/vertical-lappet-particle-field-splash";
import { VerticalLappetTornadoSplash } from "@/components/splash/vertical-lappet-tornado-splash";
import { VerticalVolumetricFieldSplash } from "@/components/splash/vertical-volumetric-field-splash";
...
const DOC_BANNERS: Record<string, DocBannerConfig> = {
  ...
  "geo-optimization": { component: BathymetrySplash, color: "#38bdf8" },
  frameworks: { component: WaveformSilkSplash, color: "#8b5cf6" },
  "research-and-benchmarking": { component: CubeMoireTextureSplash, color: "#22c55e" },
  "tooling-and-glossary": { component: HexCurrentSplash, color: "#f59e0b" },
  ...
  "market-research": { component: VerticalVolumetricFieldSplash, color: "#14b8a6" },
  "scenes-and-examples": { component: VerticalLappetTornadoSplash, color: "#f97316" },
  "products-services": { component: PosturizeSplash, color: "#8b5cf6" },
  "upskill-services": { component: LappetsSplash, color: "#10b981" },
  "target-sectors": { component: VerticalLappetParticleFieldSplash, color: "#0ea5e9" },

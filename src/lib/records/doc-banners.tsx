...
import { LagoonMirrorSplash } from "@/components/splash/lagoon-mirror-splash";
...
const DOC_BANNERS: Record<string, DocBannerConfig> = {
  ...
  "research-and-benchmarking": { component: ResonanceFieldSplash, color: "#22c55e" },
  ...
  "market-research": { component: LagoonMirrorSplash, color: "#14b8a6" },
  ...
  "current-programs-and-figures-in-ai-psychosis": { component: SiltDriftSplash, color: "#d946ef" },
  "cases-of-ai-psychosis": { component: ReefReliefSplash, color: "#84cc16" },
  "petitioning-for-medical-recognition": { component: TidepoolSplash, color: "#f43f5e" },

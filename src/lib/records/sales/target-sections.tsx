...
export const SALES_REFERENCES = {
  ...
  goto: { id: "goto", authors: "GoTo", title: "GoTo Indonesia", note: "Massive ecosystem merger with overlapping tech stacks.", photo: institutionalImg, href: "https://www.gotocompany.com/", tags: [DOC_TAGS.marketplace, DOC_TAGS.scale], painPoints: ["Data Orchestration", "Logistics Coordination"], sellingStrategy: "Normalize overlapping service signals into a single 'Ecosystem Control Layer'.", highValueTargets: [{ name: "Hans Patuwo", role: "Group CEO / President Director", email: "hans.patuwo@gotocompany.com" }, { name: "William Xiong", role: "Group CTO", email: "william.xiong@gotocompany.com" }, { name: "Ofir Shalev", role: "Group CDO", email: "ofir.shalev@gotocompany.com" }, { name: "Melissa Siska Juminto", role: "President of E-commerce", email: "melissa.siska@gotocompany.com" }], outboundStrategy: { pitchAngle: "Normalize overlapping service signals into a single 'Ecosystem Control Layer' post-merger.", triggers: ["Data Orchestration", "Logistics Coordination"] }, employeeCount: 20000 },
  ...
  toyota: { id: "toyota", authors: "Toyota", title: "Toyota Global", note: "Extreme Just-in-Time supply chain complexity.", photo: manufacturingImg, href: "https://www.toyota-global.com/", tags: [DOC_TAGS.manufacturing, DOC_TAGS.automotive], painPoints: ["Supply Chain Transparency", "EV Transition Drag"], sellingStrategy: "Normalize global factory floor signals into a central 'JIT Control Layer'.", highValueTargets: [{ name: "Kenta Kon", role: "President and CEO" }, { name: "Koji Sato", role: "Vice Chairman & CIO" }, { name: "Hiroki Nakajima", role: "EVP & CTO" }, { name: "Hajime Kumabe", role: "CEO, Woven by Toyota" }], outboundStrategy: { pitchAngle: "Arene OS and Software-Defined Vehicles require a unified operational layer to normalize factory and vehicle signals.", triggers: ["Supply Chain Transparency", "EV Transition Drag"] }, employeeCount: 370000 },

...
export const SALES_REFERENCES = {
  ...
  // --- INDONESIA ---
  brin: { id: "brin", authors: "BRIN Indonesia", note: "Institutional signals are non-normalized across 80+ disparate research institutes.", photo: institutionalImg, href: "https://www.brin.go.id/", tags: [DOC_TAGS.research, DOC_TAGS.government] },
  ...
  bambu_indah: { id: "bambu_indah", authors: "Bambu Indah", title: "Bambu Indah (Ubud)", note: "Ubud retreat signals are manual (WhatsApp/Excel). Ops are invisible.", photo: hospitalityImg, href: "https://bambuindah.com", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark], painPoints: ["WhatsApp Signal Noise", "Invisible Retreat Ops"], sellingStrategy: "Normalize raw retreat inputs. Consolidate fragmented guest requests into a central execution context." },
  aman: { id: "aman", authors: "Aman", title: "Aman Resorts", note: "High-ticket guest signals are trapped in manual, unrecorded memory. Fragile.", photo: hospitalityImg, href: "https://www.aman.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark], painPoints: ["Fragile Memory Silos", "Invisible VIP Intent"], sellingStrategy: "Sell 'Operational Memory'. Create a global control layer that normalizes VIP signals across all Aman sites." },
  yoga_barn: { id: "yoga_barn", authors: "Yoga Barn", title: "The Yoga Barn", note: "Festival signals are chaotic and non-normalized. High-cost operational drag.", photo: eventsImg, href: "https://www.theyogabarn.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.culture], painPoints: ["Festival Signal Chaos", "Manual Logistics Drag"], sellingStrategy: "Create an 'Event Pipeline'. Normalize raw logistics inputs into a single composable operational layer." },
  ayana: { id: "ayana", authors: "Ayana", title: "Ayana Estate", note: "Massive estate signals are non-normalized. Guest intent is invisible.", photo: hospitalityImg, href: "https://www.ayana.com/bali/ayana-resort-and-spa/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },
  alila: { id: "alila", authors: "Alila", title: "Alila Resorts", note: "Eco-luxury signals are manual. Context is fragmented.", photo: hospitalityImg, href: "https://www.alilahotels.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },

  // Travel (ID)
  garuda: { id: "garuda", authors: "Garuda", title: "Garuda Indonesia", note: "National carrier signals are trapped in legacy silos. High-cost drag.", photo: hospitalityImg, href: "https://www.garuda-indonesia.com/", tags: [DOC_TAGS.aviation, DOC_TAGS.enterprise] },
  traveloka: { id: "traveloka", authors: "Traveloka", title: "Traveloka", note: "Marketplace noise makes intent signals invisible. Hallucinations in recommendations.", photo: hospitalityImg, href: "https://www.traveloka.com/", tags: [DOC_TAGS.marketplace, DOC_TAGS.scale] },
  ...
  dusit: { id: "dusit", authors: "Dusit", title: "Dusit Thani", note: "Thai hospitality signals are manual. High-cost service drag.", photo: hospitalityImg, href: "https://www.dusit.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },
  banyan_tree: { id: "banyan_tree", authors: "Banyan Tree", title: "Banyan Tree", note: "Sanctuary signals are trapped in manual memory. Context is fragile.", photo: hospitalityImg, href: "https://www.banyantree.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },
  airasia: { id: "airasia", authors: "AirAsia", title: "AirAsia Group", note: "LCC operational signals are fragmented across regions. High-cost drag.", photo: hospitalityImg, href: "https://www.airasia.com/", tags: [DOC_TAGS.aviation, DOC_TAGS.scale] },
  agoda: { id: "agoda", authors: "Agoda", title: "Agoda", note: "Inventory signals are non-normalized. Pricing context is invisible.", photo: hospitalityImg, href: "https://www.agoda.com/", tags: [DOC_TAGS.marketplace, DOC_TAGS.scale] },

  // --- JAPAN & KOREA ---
  riken_aip: { id: "riken_aip", authors: "RIKEN AIP", note: "Implicit research signals are invisible. Veteran knowledge is manual.", photo: institutionalImg, href: "https://aip.riken.jp/", tags: [DOC_TAGS.research, DOC_TAGS.aiLabs] },
  obayashi: { id: "obayashi", authors: "Obayashi", note: "Paper-based site signals create massive data gaps. Real progress is invisible.", photo: constructionImg, href: "https://www.obayashi.co.jp/en/", tags: [DOC_TAGS.construction, DOC_TAGS.industrial] },
  hoshino: { id: "hoshino", authors: "Hoshino", title: "Hoshino Resorts", note: "Omotenashi signals are manual and non-normalized. Context is fragile.", photo: hospitalityImg, href: "https://www.hoshinoresorts.com/en/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },
  apa_hotels: { id: "apa_hotels", authors: "APA", title: "APA Hotels", note: "Mass-market signals are fragmented. High-cost operational drag.", photo: hospitalityImg, href: "https://www.apahotel.com/en/", tags: [DOC_TAGS.hospitality, DOC_TAGS.scale] },
  shilla: { id: "shilla", authors: "Shilla", title: "Hotel Shilla", note: "Luxury Korean hospitality signals are manual. Context is invisible.", photo: hospitalityImg, href: "https://www.hotelshilla.net/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },

  // --- AUSTRALIA ---
  crown: { id: "crown", authors: "Crown", title: "Crown Resorts", note: "Casino and resort signals are lost in massive guest noise. High-cost drag.", photo: { src: "/assets/sales/qantas_premium.png" }, href: "https://www.crownresorts.com.au/", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark] },
  meriton: { id: "meriton", authors: "Meriton", title: "Meriton Suites", note: "Apartment hotel signals are manual. Ops context is invisible.", photo: hospitalityImg, href: "https://www.meritonsuites.com.au/", tags: [DOC_TAGS.hospitality, DOC_TAGS.scale] },
  qantas: { id: "qantas", authors: "Qantas", title: "Qantas Airways", note: "National carrier signals are trapped in legacy silos. High-cost drag.", photo: { src: "/assets/sales/qantas_premium.png" }, href: "https://www.qantas.com/", tags: [DOC_TAGS.aviation, DOC_TAGS.enterprise] },

  // --- EUROPE / UK ---
  locke: { id: "locke", authors: "Locke", title: "Locke Living", note: "Multi-city aparthotel noise. Real-time guest signals are invisible.", photo: hospitalityImg, href: "https://lockeliving.com", tags: [DOC_TAGS.hospitality, DOC_TAGS.enterprise], painPoints: ["Invisible Multi-city Signals", "High-Cost Ops Noise"], sellingStrategy: "Deploy a 'Control Layer' to normalize multi-city raw inputs into a central dataset." },
  hoxton: { id: "hoxton", authors: "Hoxton", title: "The Hoxton", note: "Brand standard signals are fragmented. CRM context is non-normalized.", photo: hospitalityImg, href: "https://thehoxton.com", tags: [DOC_TAGS.hospitality, DOC_TAGS.landmark], painPoints: ["Fragmented Brand Signals", "CRM Hallucinations"], sellingStrategy: "Consolidate CRM and guest tools into a single operational layer with live domain context." },
  ...
  accor: { id: "accor", authors: "Accor", title: "Accor Group", note: "Global multi-brand noise. Guest signals are non-normalized. High-cost drag.", photo: hospitalityImg, href: "https://group.accor.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.enterprise] },
  ...
  soho_house: { id: "soho_house", authors: "Soho House", title: "Soho House", note: "Member intent signals are lost in manual community noise. Context is fragile.", photo: hospitalityImg, href: "https://www.sohohouse.com/", tags: [DOC_TAGS.hospitality, DOC_TAGS.culture] },
};

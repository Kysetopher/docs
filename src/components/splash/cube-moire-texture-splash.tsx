...
import { buildCubeMoireBands, drawCubeMoireTexture } from "@/lib/splash/cube-moire-texture";

const TARGET_FPS = 30;
const FRAME_INTERVAL_MS = 1000 / TARGET_FPS;

export function CubeMoireTextureSplash({ color = "#38bdf8" }: { color?: string }) {
